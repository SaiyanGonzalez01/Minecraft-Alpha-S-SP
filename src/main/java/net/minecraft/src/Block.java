...
public class Block {
	...
	public static final Block grimStone = (new BlockGrimstone(87, 29)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep);
	public static final Block grimCobbleStone = (new Block(87, 45, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep);
